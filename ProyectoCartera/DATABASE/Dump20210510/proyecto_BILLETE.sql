...
CREATE TABLE `BILLETE` (
  `TipoBillete` varchar(255) NOT NULL,
  `ValorBilleteEU` varchar(255) NOT NULL,
  PRIMARY KEY (`TipoBillete`)
...
INSERT INTO `BILLETE` VALUES ('5 euros','5 euros'),('cuatro','cuatro'),('diez','euro'),('tres','tres'),('veinte','euro');
